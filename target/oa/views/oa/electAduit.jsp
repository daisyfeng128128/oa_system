	...
	var grid = $.fn.bsgrid.init("searchTable", {
		...
		$("#searchTable").click(function() {
			if (grid.getSelectedRow().length > 0) {
				...
				$(".thistable .deptpass,.thistable .equipass,.thistable .personpass, .thistable .headpass,.thistable .start,.thistable .end").attr("disabled","true").addClass("tablecancel");
					if(auditp == "待审核"){
...
<div class="rightPadd">
	...
	<jsp:include page="purchaseAuditCommon.jsp"></jsp:include>
		...
		<div id="checkEl" style="display:none;margin-left:20px;margin-right:20px;">
			<table class="table2">
				<tr>
					<td colspan="1"  style="text-align:left;"><span id="reason" class="w200"></span></td>
				</tr>
				<tr>
