...
public class MenuitemServiceImpl implements IMenuitemService {
	...
	public void createMenuItems() {
		...
		createMenuItem(new MenuItem("采购审核", "purchaseAudit/show.do", items8, null, 2, Dev.NO, "部门审核:deptpass","设备人员审核:equipass","负责人审核:personpass","总公司审核:headpass", "开始处理:start", "完成处理:end","查看详情:views"));
		createMenuItem(new MenuItem("设备领用", "useAudit/show.do", items8, null, 3, Dev.NO, "新增:add", "修改:mid", "删除:del","部门审核:deptpass","设备人员审核:equipass", "完成处理:end","查看详情:views"));
		createMenuItem(new MenuItem("固定资产月报", "assetsAudit/show.do", items8, null, 4, Dev.NO,"导入文件:add","总公司审核:headpass"));
		createMenuItem(new MenuItem("违纪处理", "disciplinary/show.do", items8, null, 5, Dev.NO,"新增:add", "修改:mid", "删除:del", "部门确认:deptpass","缴纳罚款:pay"));
	}
	/**
	 * 功能：添加修改平台权限
	 * 
