...
@Repository("platformsMonthsOutlayDAO")
public class PlatformsMonthsOutlayDAO {
	...
	public void addPlatformsMonthsOutlay(PlatformsMonthsOutlay post) {
	...
	public List<PlatformsMonthsOutlay> readAllPlatformsMonthsOutlayDate() {
		try {
			DetachedCriteria detachedCriteria = DetachedCriteria.forClass(PlatformsMonthsOutlay.class);
			detachedCriteria.add(Restrictions.eq("status", EntityStatus.NORMAL));
			detachedCriteria.addOrder(Order.desc("createDT"));
			return (List<PlatformsMonthsOutlay>) baseDAO.findAllByCriteria(detachedCriteria);
		} catch (Exception ex) {
			ex.printStackTrace();
			return null;
		}
	...
	@SuppressWarnings("unchecked")
	public PlatformsMonthsOutlay readPlatformsMonthsOutlay(String platId, Integer mId, Date date1, Date date2, SearchFilter filter) {
		try {
			DetachedCriteria detachedCriteria = DetachedCriteria.forClass(PlatformsMonthsOutlay.class);
			...
			List<PlatformsMonthsOutlay> list = (List<PlatformsMonthsOutlay>) baseDAO.findAllByCriteria(detachedCriteria);
			if (list != null && list.size() > 0) {
				PlatformsMonthsOutlay outlay = list.get(0);
				if (outlay != null)
					return outlay;
			}
		} catch (Exception e) {
	 ...
	 * */
	@SuppressWarnings("unchecked")
	public BigDecimal findLastOnlineIncome(Integer branchs, String platId, Date $date1, Date $date2) {
		BigDecimal sumBaseMoney = new BigDecimal(0);
		try {
			DetachedCriteria detachedCriteria = DetachedCriteria.forClass(PlatformsOnlineIncome.class);
	 ...
	 * */
	@SuppressWarnings("unchecked")
	public BigDecimal findLastOfflineIncome(Integer branchs, String platId, Date $date1, Date $date2) {
		BigDecimal sumBaseMoney = new BigDecimal(0);
		try {
			DetachedCriteria detachedCriteria = DetachedCriteria.forClass(PlatformsOfflineIncome.class);
			detachedCriteria.add(Restrictions.eq("branchs", branchs));
	...
	public boolean savePlatformsMonthsOutlay(PlatformsMonthsOutlay outlay) {
		try {
			...
			this.baseDAO.getCurrentSession().flush();
			return true;
		} catch (Exception e) {
			e.printStackTrace();
			return false;
	...
	public PlatformsMonthsOutlay readAllPlatformsMonthsOutlay(String id) {
		if (id != null && id.trim().length() > 0) {
			PlatformsMonthsOutlay outlay = (PlatformsMonthsOutlay) this.baseDAO.get(PlatformsMonthsOutlay.class, Integer.valueOf(id));
			if (outlay != null)
				return outlay;
		}
		return null;
	 ...
	 * */
	@SuppressWarnings("unchecked")
	public PlatformsMonthsOutlay buildPlatformsMonthsOutlay(Integer branchs, Integer platId, Date date1, Date date2) {
		try {
			DetachedCriteria detachedCriteria = DetachedCriteria.forClass(PlatformsMonthsOutlay.class);
			detachedCriteria.add(Restrictions.eq("branchs", branchs));
	 ...
	 * */
	@SuppressWarnings("unchecked")
	public PlatformsMonthsOutlay findPlatformsMonthsOutlyaByLast(Integer branchs, String platId, Date date1, Date date2) {
		try {
			DetachedCriteria detachedCriteria = DetachedCriteria.forClass(PlatformsMonthsOutlay.class);
			detachedCriteria.add(Restrictions.eq("branchs", branchs));
			detachedCriteria.add(Restrictions.eq("platId", String.valueOf(platId)));
	...
	@SuppressWarnings("unchecked")
	public List<PlatformsMonthsOutlay> readAllPlatformsMonthsOutlayByAudit(Date date1, Date date2) {
		try {
			DetachedCriteria detachedCriteria = DetachedCriteria.forClass(PlatformsMonthsOutlay.class);
			detachedCriteria.add(Restrictions.between("createDT", date1, date2));
			detachedCriteria.addOrder(Order.desc("createDT"));
	...
	@SuppressWarnings("unchecked")
	public List<PlatformsMonthsOutlay> findPlatformsMonthsOutlayList(Date date1, Date date2) {
		try {
			DetachedCriteria detachedCriteria = DetachedCriteria.forClass(PlatformsMonthsOutlay.class);
			detachedCriteria.add(Restrictions.between("createDT", date1, date2));
			detachedCriteria.add(Restrictions.eq("status", EntityStatus.NORMAL));
			List<PlatformsMonthsOutlay> outlayList = (List<PlatformsMonthsOutlay>) baseDAO.findAllByCriteria(detachedCriteria);
